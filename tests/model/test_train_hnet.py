...
def test_model_initialization(model, maxdoas_sources):
    assert isinstance(model, HNetGRU), "Model is not an instance of HNetGRU"
    assert model.max_len == maxdoas_sources, f"Expected max_doas {maxdoas_sources}, got {model.max_len}"
